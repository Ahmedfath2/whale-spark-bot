...
const CONFIG = {
  COINS_TO_SCAN: 150,           // أعلى عدد عملات بالحجم نفحصها كل مرة
  MIN_SAMPLES_BEFORE_FLAG: 8,   // أقل عدد قراءات تاريخية قبل ما نثق بالمتوسط
  VOLUME_SPIKE_MULTIPLIER: 6,   // الحجم الحالي لازم يكون X أضعاف المتوسط
  MIN_PRICE_MOVE_PCT: 8,        // نسبة تحرك السعر 24 ساعة المطلوبة كتأكيد
